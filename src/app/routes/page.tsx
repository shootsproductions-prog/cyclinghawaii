    ...
    <section className="pt-24 md:pt-28 pb-12 md:pb-16 px-6 md:px-10 lg:px-16 bg-bg">
      <div className="max-w-[1280px] mx-auto">
        <div className="relative aspect-[16/8] md:aspect-[2.4/1] rounded-2xl overflow-hidden shadow-[0_20px_60px_-18px_rgba(0,0,0,0.22)] mb-10 md:mb-14">
          <Image
            src="/bike/shipwreck.jpg"
            alt="Coastal Maui road, route library"
            fill
            priority
...
function RouteCard({ route }: { route: FormattedRoute }) {
  ...
  return (
    <a
      ...
      className="group bg-card border border-border rounded-2xl overflow-hidden shadow-[0_10px_30px_-14px_rgba(0,0,0,0.18)] hover:shadow-[0_20px_50px_-18px_rgba(0,0,0,0.28)] transition-shadow flex flex-col no-underline"
    >
      {/* Map */}
